<?php
    // issue in substrate, split -> is necessary show the diference of inputs to user
...
/*
    ...
    gettype() - return a type of a variable type

    settype() - change type of data's to a variable

    $val1 = (int) 0;

    gettype($val1); // return the variable as integer

    settype($val1, "double"); // change a integer variable for double(real)
*/

// we use the command round() for format of qtd of decimal after the doc
//Ex: round($result,2)
